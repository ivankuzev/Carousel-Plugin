    ...
    $.widget( "ik.carousel",{
        ...
        _refreshNavigationEnds:function(){
            ...
            if(this.options.navigation.ends == 'standart'){
                ...
                if(this.options.orientation === 'vertical'){   
                    this.element.children('div.ik-carousel-items').css({
                        'width':this.element.width(),
                        'height':this.element.height()-(this.element.children('div.ik-carousel-end-1').outerHeight()*2)
                    });
                    ...
                    this.element.children('div.ik-carousel-items').css({
                        'width':this.element.width()-(this.element.children('div.ik-carousel-end-1').outerWidth()*2),
                ...
                this.element.children('div.ik-carousel-end-1').children().css({
                    'margin-top':marginY,
                    'margin-left':marginX
                });
                ...
                this.element.children('div.ik-carousel-end-2').children().css({
                    'margin-top':marginY,
                    'margin-left':marginX
                });
        ...
        roll:function(speed){
            ...
            if(speed === 0){
                clearInterval(this.options.rollInterval)
                
            }else{
                if(this.options.rollInterval !== undefined)clearInterval(this.options.rollInterval); 
                this.options.rollSpeed = speed;
                this.options.rollInterval = setInterval($.proxy(this._viewforward,this),this.options.rollSpeed);
            }
        },
        _viewback:function(){ 
            ...
            if(newindex < 0){
                newindex =0;
                if(this.options.rollInterval !== undefined){
                    clearInterval(this.options.rollInterval); 
                    this.options.rollInterval = setInterval($.proxy(this._viewforward,this),this.options.rollSpeed);
                }
            }
        ...
        _viewforward:function(){ 
            var newindex =  this.options.focusItem.index();
            newindex+= this.options.step;
            if(newindex >  (this.element.find('ul.ik-carousel-items').children().length-1)){
                newindex =this.element.find('ul.ik-carousel-items').children().length-1 ; 
                if(this.options.rollInterval !== undefined){
                    clearInterval(this.options.rollInterval); 
                    this.options.rollInterval = setInterval($.proxy(this._viewback,this),this.options.rollSpeed);
                }
        ...
        _setview:function(){
            ...
            if(this.options.orientation ==='vertical'){
                ...
                this.element.find('ul.ik-carousel-items').stop().animate({
                    'top':animationTarget
                },this.options.animation.speed,this.options.animation.easing);
            }else if(this.options.orientation ==='horizontal'){
        ...
        _hoverItemIn:function(event){    
            ...
            this._trigger( "hoverItemIn", null,  {
                'target':target
            } );      
        ...
        _hoverItemOut:function(event){           
            ...
            this._trigger( "hoverItemOut", null,  {
                'target':target
            } );  
        },
        ...
        _hoverCapOut:function(event){           
            ...
            $(target).removeClass(this.options.classHover);               
            $(target).addClass(this.options.classDefault);                         
            this._trigger( "hoverCapOut", null,  {
                'target':target
            } );      
